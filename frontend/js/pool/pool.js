...
/* =====================================================
    ...
    const getLockedFloorDepthAt = (worldX, worldY) => {
      ...
      // The 300 mm side offset only applies when the bench itself is curved.
      // If the bench seat is square-ended/rectangular on a straight wall, the
      // smaller steps stay flush to the bench end with no 300 mm set-in.
      const curvedSideAnchor = benchSeatModeForAnchor && hasCurvedMainWallFace({
        ...fullStepLayout,
        boundaryClip: {
          frame: stepWallFrame,
